...
const students = ['jhenypher', 'Karol kade minha calculadora', 'Gustavo', 'Marcos Terra', 'Kevin', 'Bruno de Alencar']

for(let i = 0; i < students.length; i++){
    console.log(`${students[i]} esta presente a aula`)
}
console.log(" ")
console.log('Mentira o Marcos Terra e a Karol, Não vão a aula kkkkkk')